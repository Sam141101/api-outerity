...
// // Admin tạo mã giảm giá cho tất cả người dùng có thể sử dụng
// router.post("/everybody-use", verifyTokenAndAdmin, async (req, res) => {
//   try {
...
//       expireTimeAt = null;
//     } else {
//       expireTimeAt = new Date(Date.now() + req.body.expireAt * 60 * 60 * 1000);
//     }
...
// // Admin tạo mã giảm giá cho riêng 1 cá nhân
// router.post("/person-use/:id", verifyTokenAndAdmin, async (req, res) => {
//   try {
...
// // Admin check xem code đã tồn tại chưa
// router.get("/check-code/:id", verifyTokenAndAdmin, async (req, res) => {
//   try {
...
// // Lấy ra discount theo từng select
// router.get("/list/:select", verifyTokenAndAdmin, async (req, res) => {
//   try {
